    ...
    return (
        <>
            ...
            <div className={`w-64 h-full shadow-lg fixed top-0 left-0 bg-gray-50 transition-transform duration-300 transform sm:translate-x-0 ${showSidebar ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <ul>
                    <button className='w-full px-4 py-2 bg-green-500 rounded-lg hover:bg-green-600 text-white mb-2'>My Blogs</button>
                    <button className='w-full px-4 py-2 bg-green-500 rounded-lg hover:bg-green-600 text-white mb-2'>Create Blogs</button>
